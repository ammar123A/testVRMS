<div id="myslidemenu" class="jqueryslidemenu">
    <ul>
        {{-- Dynamic Home link --}}
        @php
            $homeUrl = session('FLEET.user_type') === 'staff' ? url('/front') : url('/main');
        @endphp
        <li><a href="{{ $homeUrl }}">Home</a></li>

        {{-- STUDENT ONLY: Reservation --}}
        ...
        {{-- STAFF ONLY: Everything else --}}
        @if (session('FLEET.user_type') === 'staff')
            {{-- Fleet Management --}}
        ...
        @if (session('FLEET.user_type') === 'admin')

...
$request_array ['status'] = array("REQUESTED", "REJECTED", "IN PROGRESS", "APPROVED", "COMPLETED");
$request_array ['type'] = array("UNTIL FINISH", "SEND", "FETCH", "SEND AND FETCH");
$request_array ['PHB'] = array("UTM" => "PHB - UNIVERSITI TEKNOLOGI MALAYSIA", "UTMIC" => "PHB - UNIVERSITI TEKNOLOGI MALAYSIA (KAMPUS ANTARABANGSA)");
